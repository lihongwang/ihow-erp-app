    ...
    initNewCanvas() {
      ...
      query
        ...
        .node((res) => {
          ...
          canvasNode.width = this.systemInfo.screenWidth * 1.6 // canvasNode.width * 1.6 //this.systemInfo.pixelRatio
          canvasNode.height = this.systemInfo.screenWidth * 1.6 // canvasNode.height * 1.6 //this.systemInfo.pixelRatio
