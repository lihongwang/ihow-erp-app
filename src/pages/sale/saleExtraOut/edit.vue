<template>
  <view class="saleExtraOut-page main-edit-page page-wrapper">
    <Navbar
      :is-back="true"
      back-icon-color="#fff"
      back-text=""
...
import { useSubscribe, useCustomer, useWarehouse, usePage, useEditPage } from '@/hooks'
